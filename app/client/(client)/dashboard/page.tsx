...
export default function ClientHome() {
  ...
  return (
    <div className="space-y-7 pb-4">
      {/* Hero Section */}
      <div className="relative rounded-2xl overflow-hidden bg-gradient-to-br from-[#C9A96E]/10 via-transparent to-transparent px-5 pt-7 pb-5">
      ...
      {/* Trust Strip */}
      <section>
        <div className="flex items-center justify-center gap-5 py-4 border-t border-white/5">
          <div className="flex items-center gap-1.5">
            <svg className="w-3.5 h-3.5 text-[#C9A96E]" viewBox="0 0 20 20" fill="currentColor">
          ...
          <div className="flex items-center gap-1.5">
            ...
            <span className="text-white/30 text-[10px]">Secure Payments</span>
          </div>
          <div className="flex items-center gap-1.5">
            <svg className="w-3.5 h-3.5 text-[#C9A96E]" viewBox="0 0 20 20" fill="currentColor">
              <path d="M10 2a6 6 0 00-6 6v3.586l-.707.707A1 1 0 004 14h12a1 1 0 00.707-1.707L16 11.586V8a6 6 0 00-6-6zM10 18a3 3 0 01-3-3h6a3 3 0 01-3 3z" />
            </svg>
            <span className="text-white/30 text-[10px]">24/7 Support</span>
          </div>
        </div>
      </section>
    </div>
