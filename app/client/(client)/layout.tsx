...
export default function ClientLayout({
  ...
  return (
    <div className="min-h-screen bg-charcoal flex flex-col">
      {offline && (
        <div className="fixed top-0 inset-x-0 z-[60] bg-warning/15 border-b border-warning/30 backdrop-blur-md" style={{ paddingTop: 'env(safe-area-inset-top, 0px)' }}>
          <div className="flex items-center justify-center gap-2 px-4 py-2 text-warning-fg text-xs font-medium">
      ...
      <header className="bg-charcoal/95 backdrop-blur-md border-b border-white/5 sticky top-0 z-40" style={{ paddingTop: 'env(safe-area-inset-top, 0px)' }}>
