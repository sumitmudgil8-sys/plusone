    ...
    >
      <div className="relative rounded-2xl overflow-hidden bg-[#121212]" style={{ aspectRatio: '3/4' }}>
        ...
        {companion.primaryImageUrl || companion.avatarUrl ? (
          ...
          <div className="w-full h-full flex items-center justify-center text-4xl font-medium text-white/20 bg-[#1a1a1a]">
        ...
        {label && (
          <div className="absolute top-2.5 left-2.5">
            <span className="bg-[#C9A96E] text-black text-[10px] font-bold uppercase tracking-wider px-2 py-0.5 rounded-full">
              {label}
            </span>
          </div>
        )}
        ...
        {!companion.accessible && (
          <div className="absolute inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center">
            <div className="text-center">
              <svg className="w-6 h-6 text-[#C9A96E] mx-auto mb-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="absolute bottom-0 inset-x-0 p-3">
          ...
          {/* Rate */}
          {chatRate && (
            <p className="text-[#C9A96E] text-[11px] font-medium mt-1.5">
              from ₹{chatRate}/min
            </p>
          )}
        </div>
