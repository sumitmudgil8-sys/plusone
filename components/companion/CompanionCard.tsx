    ...
    <Link href={accessible ? `/client/booking/${id}` : '#'} onClick={(e) => !accessible && e.preventDefault()}>
      <Card
        className={cn(
          ...
          accessible ? 'cursor-pointer hover:shadow-xl hover:border-gold/30' : 'opacity-75'
        )}
      ...
      >
        ...
        <div className="relative aspect-[4/3] bg-charcoal-border overflow-hidden">
          {displayImage ? (
            ...
            <div className="w-full h-full flex items-center justify-center text-4xl font-medium text-white/30">
              {name.charAt(0)}
            </div>
          )}
